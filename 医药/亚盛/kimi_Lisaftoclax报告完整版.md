...
Lisaftoclax是一种基于N-苯甲酰胺骨架的口服小分子BCL-2抑制剂。该骨架的设计遵循了BH3模拟物开发的经典策略：通过模拟BH3-only蛋白的α-螺旋结构，将疏水性的BH3结构域药效团嵌入BCL-2蛋白表面的疏水性BH3结合沟槽（hydrophobic groove，包含P1-P4四个亚口袋），从而竞争性置换被BCL-2隔离的促凋亡蛋白。
